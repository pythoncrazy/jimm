...
class CLIP(nnx.Module):
    def __init__(
        ...
        self.positional_embedding = nnx.Param(sharded_init(nnx.initializers.truncated_normal(stddev=0.02), (None, "model"), mesh)(rngs.params(), (context_length, transformer_width)))
